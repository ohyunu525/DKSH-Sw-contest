...
gym.register(
    id="Isaac-DKSH-MG90S-CAD6-Velocity-Direct-v3",
    entry_point=f"{__name__}.mg90s_cad6:MG90SCad6VelocityEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.mg90s_cad6:MG90SCad6VelocityV3EnvCfg",
        "rsl_rl_cfg_entry_point": f"{__name__}.mg90s_cad6:MG90SCad6VelocityV3RunnerCfg",
    },
)

gym.register(
    id="Isaac-DKSH-MG90S-CAD6-Velocity-Direct-v2",
    entry_point=f"{__name__}.mg90s_cad6:MG90SCad6VelocityEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.mg90s_cad6:MG90SCad6VelocityV2EnvCfg",
        "rsl_rl_cfg_entry_point": f"{__name__}.mg90s_cad6:MG90SCad6VelocityV2RunnerCfg",
    },
)
