...
| 개수 | 관측값 |
| --- | --- |
| 16 | Unitree 4D LiDAR L1 RM을 16방향으로 축약한 수평 장애물 거리 |
| 9 | 로봇 주변 지점의 지형 높이 |
| 3 | 움직이는 바닥의 3축 속도 |
...
±2 cm 정확도 및 8 mm 거리 분해능을 기록합니다. 학습 입력에는 수평 11 Hz sample-and-hold,
±2 cm 균등 오차와 8 mm 양자화를 적용합니다.

병렬 학습 비용을 제한하기 위해 21,600 points/s 전체 3D 점군을 정책에 직접 넣지 않고, 로봇 루트
높이의 360° 시야를 16개 방향으로 투영합니다. 거리 계산 대상도 시나리오 형상의 축 정렬 경계 상자
(AABB)이므로 수직 90° 분포, 반사율에 따른 누락, 재질·날씨·가림 현상은 아직 모델링하지 않습니다.
